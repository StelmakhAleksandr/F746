...
struct SdcrConfiguration
{
    ...
    {
        return (static_cast<uint32_t>(column) << FMC_SDCR1_NR_Pos) | (static_cast<uint32_t>(dataWidth) << FMC_SDCR1_MWID_Pos) | (static_cast<uint32_t>(bankCount) << FMC_SDCR1_NB_Pos) | (static_cast<uint32_t>(casLatency) << FMC_SDCR1_CAS_Pos) | (static_cast<uint32_t>(sdramClock) << FMC_SDCR1_SDCLK_Pos) | (static_cast<uint32_t>(burstRead) << FMC_SDCR1_RBURST_Pos) | (static_cast<uint32_t>(readPipe) << FMC_SDCR1_RPIPE_Pos);
    }
};
...
struct SdtrConfiguration
{
    ...
    uint32_t value() const
    {
        return (static_cast<uint32_t>(modeRegToActive) << FMC_SDTR1_TMRD_Pos) | (static_cast<uint32_t>(exitSelfRefresh) << FMC_SDTR1_TXSR_Pos) | (static_cast<uint32_t>(activeToPrecharge) << FMC_SDTR1_TRAS_Pos) | (static_cast<uint32_t>(rowCycle) << FMC_SDTR1_TRC_Pos) | (static_cast<uint32_t>(writeRecovery) << FMC_SDTR1_TWR_Pos) | (static_cast<uint32_t>(rowPrecharge) << FMC_SDTR1_TRP_Pos) | (static_cast<uint32_t>(rowToColumn) << FMC_SDTR1_TRCD_Pos);
    }
};
...
struct MrdConfiguration
{
    ...
    uint32_t value() const
    {
        return (static_cast<uint32_t>(casLatency) << MRD_CAS_LATENCY_POS) | (static_cast<uint32_t>(burstLength) << MRD_BURST_LENGTH_POS) | (static_cast<uint32_t>(burstType) << MRD_BURST_TYPE_POS) | (static_cast<uint32_t>(writeMode) << MRD_WRITE_MODE_POS);
    }
};
